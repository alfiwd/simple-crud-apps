...
public class loginMenu extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(usernameInput, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        if(username.equals("") || password.equals("")){
            utils.showMessage("Username dan password tidak boleh kosong");
        }else{
            try{
                String querySelect = "SELECT username, password FROM user WHERE username = '" + username + "' AND password = '" + password + "'";
                ...
                if(res.next()){
                    ...
                    utils.showMessage("Username atau password tidak sesuai");
                }
            }catch(Exception e){
